...
export const Footer = () => {
  return (
   <footer className='mt-[5rem] w-screen flex flex-col items-center'>
      <div className='w-[80%]  flex justify-between lg:w-[95%] lg:flex-wrap'>
        <div className='w-[20%] p-4 gap-4 flex flex-col lg:w-[50%] md:w-full'>
          <h3 className='text-[3rem] font-semibold'>Jadoo.</h3>
          <p className=''>Book your trip in minute, get full Control for much longer.</p>
        </div>
        <div className='w-[15%] p-6 gap-4 flex flex-col lg:w-[30%] md:w-[80%]'>
        ...
        <div className='w-[30%] p-6 flex flex-col gap-4 items-center lg:w-[45%] md:w-[80%]'>
