...
export const HeaderComponent = () => {
  return (
    <div className='w-[80%] h-[95vh] flex md:flex-col  lg:mb-[3rem] md:[95%]'>
      <div className='w-[45%] h-[90%] md:h-full pt-[5rem] md:w-[90%]'>
        <div className='w-full h-full  flex flex-col gap-3 items-center md:w-full'>
            <p className='text-[1.5rem] font-[700] text-secondary-500'>Best Destinations around the world</p>
           <div className='w-full'>
           <h2 className='text-[4rem] font-semibold font-volkhov w-full lg:text-[2rem] flex '>Travel,<span className='flex flex-col'> <span>enjoy</span> <span className='w-full h-[1.5rem'>
          <img src={Decore} alt="" className='h-full' />
           </span>  </span> </h2>
           <h2 className='text-[4rem] font-volkhov w-full lg:text-[2rem] font-semibold'>and live a new and full life</h2> 
           </div>
           ...
           <div className='w-full'>
            <div className='w-[80%] flex gap-3 items-center md:w-full '>
             ...
             <div className='flex items-center gap-2'>
                ...
                <svg fill="none" className='h-[1rem] w-[1rem] fill-white stroke-none' stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
