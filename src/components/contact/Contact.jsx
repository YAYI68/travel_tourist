    ...
    <section className='mt-[4rem] w-[80%] relative'>
       <div className='py-[2rem] flex flex-col gap-[5rem] items-center bg-[#DFD7F9]  rounded-tl-[8rem]'>
        <div className='w-[70%] font-medium'>    
          <h3 className='text-[2rem] text-center text-[#5E6282]'>Subscribe to get information, latest news and other interesting offers about Jadoo</h3>
        </div>
       <div className='h-[3.5rem] w-[60%] flex gap-5 items-center '>
