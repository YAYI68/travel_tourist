...
export const Contact = () => {
  return (
    <section className='my-[4rem] w-[80%] relative md:w-[90%] '>
       <div className='py-[4rem] flex flex-col gap-[5rem] md:gap-4 items-center bg-[#DFD7F9]  rounded-tl-[8rem] relative overflow-hidden '>
       ...
       <div className='h-[3.5rem] lg:h-[2.5rem] w-[50%] flex gap-5 md:gap-2 items-center md:flex-col md:w-[80%] '>
        ...
        <div className='top-8 right-0 absolute  h-[12rem] w-[12rem]  '>
           <img src={Circle1} alt="" />     
        </div>
        <div className='bottom-[-4rem] left-0 absolute h-[15rem] w-[15rem]  '>
           <img src={Circle2} alt="" />     
        </div>
       </div> 
        ...
        <div className='top-0 right-0 absolute h-[5rem] w-[5rem]  -translate-y-1/2 translate-x-1/2'>
           <img src={Circle2} alt="" />     
        </div>
    </section>
  )
